...
subplot(3,1,3);plot(meas_time_P,magn_P(3,:)/1370,PacketMagGyroAcc*t+60*60*13+19*60+44, -MagnetometerZ0x28G0x29+0.5,meas_time_X(1,:),-(magn_X(3,:)-2^15)/15007.5);title('Magnetometer x-axis');legend('PX4','x-IMU','MTi-G');xlabel('[s]');ylabel('[gauss]');
...
subplot(3,1,3);plot(meas_time_P,magn_P(1,:)/1370+0.3781-0.07,PacketMagGyroAcc*t+60*60*13+19*60+44, MagnetometerX0x28G0x29-0.5,meas_time_X(1,:),(magn_X(1,:)-2^15)/15007.5);title('Magnetometer x-axis');legend('PX4','x-IMU','MTi-G');xlabel('[s]');ylabel('[gauss]');