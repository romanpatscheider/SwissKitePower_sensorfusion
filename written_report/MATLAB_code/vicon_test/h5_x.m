...
%calculating additional speed through the displacment of the IMU and the
...
% add the displacement vector to the position and the displacement velocity
% to the velocity
...
% additional acceleration through velocity
...
h5=DCM_bi*mag;
% calculate cardan angles from states (not used for correction! -> complex
