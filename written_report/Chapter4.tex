...
In this section the influence of the different IMU's on the estimator is presented. The above test of the estimator without having a GPS signal and only using the MTi-G data is carried out again with only the PX4 measurements. %In figure \ref{detail_no_GPS_P} the same detail is shown. 
%\begin{figure}[h]
%\centering
...
\label{error_noGPS_P}
\end{figure}
%The calculation of the error ratios shows the big impact of the measurement unit.
